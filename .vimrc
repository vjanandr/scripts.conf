...
"au FileType python Bundle 'Valloric/YouCompleteMe'
"au FileType python Plugin 'vim-scripts/indentpython.vim'
...
au FileType c Plugin 'vim-scripts/c.vim'
au FileType c Plugin 'mbbill/code_complete'
